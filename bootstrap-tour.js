...
(function(window, factory) {
  ...
  Tour = (function() {
    ...
    Tour.prototype.init = function(force) {
	  ...
	  if(typeof this._options.overlayWindowFactory === 'boolean' && window.OverlayWindow) {
		  var elms = [];
		  for(var x = 0; x < this._options.steps.length; x++)
			  elms.push($(this._options.steps[x].element)[0]);
		  this._options.overlayWindowFactory = new window.OverlayWindow(elms, this._options.overlayWindowConfig);
	  }
      this._inited = true;
      return this;
    };
    ...
    Tour.prototype.end = function() {
      ...
      endHelper = (function(_this) {
        return function(e) {
          ...
          _this._force = false;
          _this._clearTimer();
		  if(_this._options.overlayWindowFactory)
			  _this._options.overlayWindowFactory.dispose();
      ...
      showStepHelper = (function(_this) {
        return function(e) {
          ...
          showPopoverAndOverlay = function() {
			...
			if(_this._options.overlayWindowFactory)
				if(!step.overlayWindow) _this._options.overlayWindowFactory.hide();
				else _this._options.overlayWindowFactory.show(i);
    ...
    Tour.prototype._showOverlayElement = function(step, force) {
      ...
      if (!this.backdrop.overlayElementShown) {
        ...
        this.backdrop.$background = $('<div>', {
		  ...
		  "style": step.backdrop_backgroundColor ? 'background-color:' + step.backdrop_backgroundColor : 'background-color: transparent'
        });
